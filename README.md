...
**[MyCloudApp](https://github.com/maxter9595/MyCloudApp.git)** – a full-stack cloud storage app with user quotas, secure file sharing, and an admin panel       <div style="margin-top: -7.5px;">
...
**[EngStudyBot](https://github.com/maxter9595/EngStudyBot.git)** – a Telegram bot for learning English in a multiple-choice card game format (4000+ words with Russian translations)    <div style="margin-top: -7.5px;">
